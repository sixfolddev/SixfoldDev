...
namespace RoomAid.ServiceLayer.Archive
{
    public class ArchiveConfig
    {
        ...
        private const string LOG_STORAGE_DIRECTORY = @"C:\LogStorage\";

        //The directory path for Archived file storages
        private const string ARCHIVE_STORAGE_DIRECTORY = @"C:\ArchiveStorage\";
        ...
        private readonly DriveInfo driveOfArchive = new DriveInfo("C");
        ...
        private const string SEVEN_ZIP_PATH = @"C:\7-Zip\7z.exe";
        ...
        //The file format for log files, according to the requirement should be .csv
        private const string LOG_EXTENSION = ".csv";
